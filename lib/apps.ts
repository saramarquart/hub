...
export const apps: AppTile[] = [
  ...
  { name: 'paf_training', description: 'Mandatory employee training & compliance quizzes.', href: 'https://paf-training-web-production.up.railway.app', icon: '/icons/paf-training.svg', category: 'internal' },
